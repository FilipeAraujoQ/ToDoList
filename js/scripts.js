...
let oldInputValue //colocando ele no global pra editar depois
...
document.addEventListener("click", (e) => {
    ...
    if(targetEl.classList.contains("finish-todo")) {
        parentEl.classList.toggle("done")  //parte de marcação
    ...
    if(targetEl.classList.contains("remove-todo")) {
        parentEl.remove(); //remoção de elemento

        removeTodoLocalStorage(todoTitle);
    }
})

///parte de cancelar a edição
...
//parte de cancelar a edição vazia
